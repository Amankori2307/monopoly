...
export const TURN_RULE_COVERAGE: RuleCoverageMap = {
  ...
  '6.9': [
    'gives three attempts, charging nothing until the third fails',
    'takes three attempts, and charges nothing until the third',
  ...
  '6.12': [
    ...
    'takes no money at all across two failed attempts',
  ],
