...
export const TURN_RULE_COVERAGE: RuleCoverageMap = {
  ...
  '6.6': ['lets a player who pays the fine roll and move normally'],
  '6.7': [
    'returns a used card to the deck it came from',
    'returns a Community Chest card to the Community Chest deck',
  ],
  '6.8': ['frees a player who rolls doubles, and ends their turn'],
  '6.9': ['keeps a broke player in Jail on the mandatory third-turn fine'],
  ...
  '6.12': ['keeps a player in Jail when the roll is not doubles'],
