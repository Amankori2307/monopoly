...
export const ASSET_RULE_COVERAGE: RuleCoverageMap = {
  ...
  '12.5': [
    ...
    'adds nothing for the faces that are not numbers',
  ],
  '12.6': [
  ...
  '12.9': ['frees a player who rolls doubles, and ends their turn'],
  '12.10': ['adds a numeric face to the move without touching the doubles count'],
  '12.11': [
    'asks where to go when all three dice match',
    'moves to any chosen space',
    'grants no extra roll: a triple is not a double',
    'lets a triple move to any space on the board',
  ],
  '12.12': ['resolves each roll in turn and keeps their outcomes when the third jails'],
  '12.13': [
    'runs once the decision the landing raised has been answered',
