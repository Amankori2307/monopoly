        ...
        <article className="rules-booklet">
          <section className="rules-intro">
            ...
            <p>
              ...
              structure but uses Indian cities, railway stations, rupee-style money, and
              India Edition values.
            </p>
          ...
          <section id="start">
            ...
            <ol>
              <li>
                Choose a Banker. The Banker controls the bank&apos;s money, title deeds,
                houses, hotels, and auctions.
              </li>
              <li>Give each player M1500. Keep the remaining money in the Bank.</li>
              <li>
                Shuffle Chance and Community Chest separately and place both decks face
                down.
              </li>
              <li>Each player chooses a token and places it on GO.</li>
              <li>
                Each player rolls both dice. The highest roll goes first; play moves to
                the left.
              </li>
            </ol>
          ...
          <section id="turn">
            ...
            <p className="callout">
              Passing or landing on GO pays M200. Going directly to Jail does not pay the
              GO salary.
            </p>
          </section>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Owned city</td>
                    <td>
                      Pay the rent on its Title Deed card. A completed color set earns
                      increased rent, and buildings increase it further.
                    </td>
                  </tr>
                  <tr>
                    <td>Railway</td>
                    <td>
                      Rent rises as its owner gains more railways: M25, M50, M100, then
                      M200.
                    </td>
                  </tr>
                  <tr>
                    <td>Utility</td>
                    <td>
                      Roll again for rent: 4× the dice roll if the owner has one utility,
                      or 10× if they own both.
                    </td>
                  </tr>
                  <tr>
                    <td>Chance / Community Chest</td>
                    <td>
                      Draw the top card, follow it immediately, then return it to the
                      bottom unless it is a Get Out of Jail Free card.
                    </td>
                  </tr>
                  <tr>
          ...
          <section>
            ...
            <p>
              When you land on an unowned city, railway, or utility, buy it at the listed
              price and take the title deed. If you do not buy it, the Banker must auction
              it to all players.
            </p>
            <ul>
              <li>Auctions start at M10.</li>
              <li>
                Any player, including the player who landed there and the Banker if
                playing, may bid.
              </li>
              <li>Each bid can increase by as little as M1.</li>
              <li>
                The highest bidder pays the Bank and takes the title deed. If nobody bids,
                the asset remains with the Bank.
              </li>
            </ul>
          </section>
          ...
          <section id="jail">
            ...
            <ol>
              ...
              <li>
                Use or buy a Get Out of Jail Free card, return it to the bottom of its
                deck, then roll and move.
              </li>
              <li>
                Try to roll doubles. If you do, move by that roll and your turn ends.
              </li>
            </ol>
            <p>
              You have up to three turns to roll doubles. If you fail on your third turn,
              pay M50 and use that final roll to move. While in Jail, you can still
          ...
          <section id="buildings">
            ...
            <ul>
              <li>
                Complete a color set before buying houses. Rent on unimproved properties
                in a completed set increases.
              </li>
              <li>
                Pay the listed house cost to the Bank and build evenly across the whole
                set.
              </li>
              <li>You may build up to four houses on each city.</li>
              <li>
                When every city in a complete set has four houses, upgrade a city to one
                hotel by paying its hotel cost and returning the four houses to the Bank.
              </li>
              <li>
                You cannot build in a color set while any city in that set is mortgaged.
              </li>
              <li>
                There are 32 houses and 12 hotels. If supply is contested, the Banker
                auctions the last available building from M10.
              </li>
            </ul>
          </section>
          ...
          <section id="money">
            ...
            <ul>
              <li>
                Sell houses and hotels back to the Bank for half their cost. Houses must
                be sold evenly across a color set.
              </li>
              <li>Before mortgaging a city, sell all buildings in its color set.</li>
              <li>
                To mortgage, turn the title deed face down and take its mortgage value
                from the Bank. Mortgaged assets collect no rent.
              </li>
              <li>To unmortgage, pay the mortgage value plus 10%.</li>
            </ul>
            <h3>Deals and trades</h3>
            <p>
              Players may buy, sell, or swap property at any time. Trades may include
              cash, property, and Get Out of Jail Free cards. Buildings cannot be traded
              and must first be sold to the Bank. No loans, future promises, or private
              rent agreements are part of the game.
            </p>
            <h3>If you cannot pay</h3>
            <p>
              First try selling buildings and mortgaging property. If you still cannot
              pay, you are bankrupt and leave the game. Debt to another player transfers
              your mortgaged properties and jail-free cards to that player; they must
              immediately repay the mortgage or pay 10% to keep it mortgaged. Debt to the
              Bank returns your properties to the Bank, cancels mortgages, and auctions
              those properties. Play continues until one player remains.
            </p>
          </section>
          ...
          <section id="speed-die">
            ...
            <p>
              The India Edition box includes a Speed Die. It is optional and is not used
              until every player has passed GO for the first time. At the start of a Speed
              Die game, each player receives an extra M1000.
            </p>
            <ul>
              ...
              <li>
                Only white dice count for doubles and for rolling out of Jail. If all
                three dice match, move to any space on the board.
              </li>
            </ul>
            <p className="source-note">
          ...
          <section className="rules-closing">
            <h2>How to win</h2>
            <p>
              Buy, collect rent, build, trade, and manage your cash until every other
              player is bankrupt. The last player left in the game wins.
            </p>
          </section>
        </article>
      </main>
