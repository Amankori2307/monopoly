...
export function RulesBoardExtra() {
  ...
  return (
    <section id="auction">
      ...
      <p>
        When you land on an unowned {nouns.site}, {nouns.railway}, or utility, buy it at
        the listed price and take the title deed. If you do not buy it, the Banker must
        auction it to all players.
      </p>
      <ul>
        <li>Auctions start at {money(AUCTION_START_PRICE)}.</li>
        <li>
          Any player, including the player who landed there and the Banker if playing, may
          bid.
        </li>
        <li>Each bid can increase by as little as {money(AUCTION_MIN_INCREMENT)}.</li>
        <li>
