...
| 3.3 | Each player is given a colour of their own from the palette (`PLAYER_COLORS`)                                                                                                                                  | ✅     |
...
| 14.10 | A card moves the player **backwards** past GO                                                                  | No salary — you only collect going forwards                                                    | ✅ `movePlayerTo` takes a required `MoveDirection` |
