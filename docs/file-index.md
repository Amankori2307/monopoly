...
| [themes/playerColors.constants.ts](../src/domain/themes/playerColors.constants.ts)                       | The eight player colours, one list for every edition, assigned by seat.                                                                                      |
...
| [game/boardOwnership.utils.ts](../src/features/game/boardOwnership.utils.ts)                                      | Builds the board's owner-marker map from ownership plus each owner's palette colour.                          |
...
| [utilities/\_player-dot.scss](../src/styles/utilities/_player-dot.scss)           | A player's colour as a mark beside their name. The third copy of two that differed by a pixel.                          |
...
| [supabase/migrations/0001_games.sql](../supabase/migrations/0001_games.sql)                                         | The online schema: three tables, four security-definer RPCs, no direct table grants.                             |
