...
| [deed/SpaceCard.tsx](../src/components/game/deed/SpaceCard.tsx)               | The site card: title, icon, per-kind deed body, and optional actions. Supplies its own fixed-size surface; shared by the deed modal, the buy decision, and the holdings drawer. |
| [deed/SpaceCard.test.tsx](../src/components/game/deed/SpaceCard.test.tsx)     | The card shell class, the shared deed footer marker, and optional actions.                                           |
